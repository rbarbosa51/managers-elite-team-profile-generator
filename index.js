...
async function main() {
  ...
  console.log(
    `Welcome to the ${chalk.bold.red("Manager's Elite Team Profile Generator")}`
  );
  console.log(
    `This application will assist you in generating a ${chalk.bold.yellow(
      "Webpage"
    )} with your team members information\nPlease answer all prompts in order to populate your team`
  );
  await inquirer
    .prompt([{ name: "pause", message: "Press Enter to continue" }])
    .then(() => ClearScreen());
      ...
      .prompt([
        {
          ...
          message:
            "Choose to add an Intern, Engineer, or Finsish Building your team:",
          choices: [
            "Create an Intern",
            "Create an Engineer",
